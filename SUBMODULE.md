# Git Submodule: neuromem

⚠️ **This directory is a Git submodule** - it's a separate repository!

## Repository Information

- **Name:** packages/sage-middleware/src/sage/middleware/components/sage_mem/neuromem
- **Repository:** https://github.com/intellistream/neuromem.git
- **Branch:** main-dev
- **Path:** `packages/sage-middleware/src/sage/middleware/components/sage_mem/neuromem`
...
git commit -m "chore: update neuromem submodule reference"
git push origin main-dev
```
...
cd ../../../../../../../
git add packages/sage-middleware/src/sage/middleware/components/sage_mem/neuromem
git commit -m "chore: update neuromem to latest"
```
...
**Solution:** 
```bash
cd packages/sage-middleware/src/sage/middleware/components/sage_mem/neuromem  # Enter the submodule first
git add .
...
git add packages/sage-middleware/src/sage/middleware/components/sage_mem/neuromem
git commit -m "chore: update neuromem reference"
```
